...
import { fetchSessions, fetchSession, createSession, cancelSession, getLogsUrl } from '@/lib/api/sessions';
...
describe('sessions API', () => {
  ...
  it('cancelSession sends POST', async () => {
    ...
    expect(mockApiFetch).toHaveBeenCalledWith('/sessions/s1/cancel', { method: 'POST' });
  });
